SELECT ma.cd_matia as old_materia_cd,
    ...
    fi.cd_matia as old_filmes_cd,
    fi.nm_filme_orige as old_filmes_nm_origem,
    fi.ds_filme_tempo as old_filmes_ds_tempo,
    fi.ds_filme_site as old_filmes_ds_site,
    fi.dt_filme_ano as old_filmes_dt_ano,
    fi.cd_midia_tralr as old_filmes_cd_midia_trailer,
    fi.ds_filme_tralr as old_filmes_ds_trailer,
    fi.cd_tetag_tralr as old_filmes_cd_tetag_trailer,
    fi.id_filme_midia_tralr_h as old_filmes_id_midia_tralr_h,
    fi.id_filme_midia_tralr_w as old_filmes_id_midia_tralr_w,
    fi.ds_filme_midia_tralr as old_filmes_ds_midia_tralr,
    fi.ds_filme_midia_credi_tralr as old_filmes_ds_midia_credi_tralr,
    fi.ds_filme_sinop as old_filmes_ds_sinop,
    fi.ds_filme_diret as old_filmes_ds_diret,
    fi.ds_filme_ator as old_filmes_ds_ator,
    fi.cd_gener as old_filmes_cd_gener,
    fi.ds_filme_class as old_filmes_ds_filme_class
FROM matia ma
...
WHERE ma.id_matia_tipo = 5 -- id do tipo filme
;CREATE VIEW filmes_migration2 AS
SELECT ma.cd_matia as old_materia_cd,
    ma.cd_site as old_materia_cd_site,
    ma.id_matia as old_materia_id,
    ma.dt_matia_incl as old_materia_data_inclusao,
